...
##### Known issues ######
# 1. The logging of racadm commands does not redirect error messages to the file
# 2. The script does not alert the user if any of the racadm commands fail
# 3. Menu items 2-4 don't work
# 4. The confirmation display for Configure new idrac process doesn't display the idrac address correctly if there's only 1 server to be configured
...
function Update-Idrac {
    ...
    "$time $fullcmd" >> idrac-config-log.txt
    Write-Host $fullcmd
    Invoke-Expression $fullcmd	*>&1 >> idrac-config-log.txt
}
...
function Configure-RootPassword {
    ...
    Update-Idrac -ip $idracIp -uname "root" -pw $currentPw -command "set idrac.Users.2.Password $newPw"
...
function Configure-DnsNtp {
    ...
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.ipv4static.dns1 $dns1"
	Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.ipv4static.dns2 $dns2"
    ...
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.time.timezone Asia/Singapore"
	Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.NTPConfigGroup.NTPEnable 1"
	Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.NTPConfigGroup.NTP1 $ntp1"
	Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.NTPConfigGroup.NTP2 $ntp2"
...
function Configure-Hostname {
	...
	Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set iDRAC.NIC.DNSRacName $hostname"
...
function Configure-DirectoryService {
    ...
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.AuthTimeout 15"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.CertValidationEnable Disabled"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.Connection LDAPS"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.DCLookupByUserDomain Enabled"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.DCLookupDomainName $domain"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.DCLookupEnable Disabled"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.userdomain.1.name $domain"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.DomainController1 $server1"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.DomainController2 $server2"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.Enable Enabled"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.GCLookupEnable Disabled"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.GCRootDomain sg.csc"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.GlobalCatalog1 $server1"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.GlobalCatalog2 $server2"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.RacDomain $domain "
    #Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.RSASecurID2FAAD Disabled"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.Schema 2"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.activedirectory.SSOEnable Disabled"

    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.1.domain sg.csc"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.1.name idrac-admin"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.1.privilege 0x1ff"

    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.2.domain sg.csc"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.2.name idrac-operator"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.2.privilege 0x0f3"

    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.3.domain sg.csc"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.3.name idrac-readonly"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set idrac.adgroup.3.privilege 0x001"
...
function Configure-BiosTimezone {
    ...
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "set bios.miscsettings.timezone UTCP0800"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "jobqueue create BIOS.Setup.1-1"
    Write-Host -ForegroundColor Yellow "Rebooting server $idracIp"
    Update-Idrac -ip $idracIp -uname "root" -pw $rootPw -command "serveraction powercycle"
}
...
function Configure-Idrac {
    ...
    do {
        ...
        Write-Host "`tServer IPs: $($idracArray[0]) ... $($idracArray[-1])"
    ...
    foreach ($idrac in $idracArray) {
        ...
        Configure-RootPassword -idracIp $idrac -currentPw $rootPasswords[0] -newPw $rootPasswords[1]
        Write-Host ""
    
        Configure-DnsNtp -idracIp $idrac -rootPw $rootPasswords[1] -dns1 $dnsNtpLdap[0] -dns2 $dnsNtpLdap[1] -ntp1 $dnsNtpLdap[2] -ntp2 $dnsNtpLdap[3]
        Write-Host ""
    
        Configure-Hostname -idracIp $idrac -rootPw $rootPasswords[1] -location $hostnameParams[0] -model $hostnameParams[1]  -nodeNumber $nodeNumber      
        $nodeNumber++
        Write-Host ""
    
        Configure-DirectoryService -idracIp $idrac -rootPw $rootPasswords[1] -domain "sg.csc" -server1 "ad-1.sg.csc" -server2 "ad-2.sg.csc"
        Write-Host ""
    }
    ...
    if ($proceed -eq "y") {
        foreach ($idrac in $idracArray) {
            Configure-BiosTimezone -idracIp $idrac -rootPw $rootPasswords[1]
        }
    }
